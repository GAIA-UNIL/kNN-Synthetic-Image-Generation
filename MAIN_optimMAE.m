...
if sensiAnalysis == false
    ...
    if netCDFtoInputs == true || optimPrep == true || validationPrep == true
        ...
        [climateData,LdateStart,LdateEnd] = extractClimateData(climateVars,rawData,normMethods,QdateStart,QdateEnd,LdateStart,LdateEnd,longWindow,inDir,saveMats);
...
%     end
    ...
    if shortWindow == 0
        toRemove = contains(variableNames, "Short");
        variableNames(toRemove) = [];
    end
